...
MIGRATIONS = (
    ...
    Migration(4, "erp2b_deterministic_results", (
        """CREATE TABLE erp_simulacion_periodos (
            id_simulacion_periodo INTEGER PRIMARY KEY AUTOINCREMENT,
            id_comunidad INTEGER NOT NULL,
            id_simulacion INTEGER NOT NULL,
            clave_periodo TEXT NOT NULL,
            fecha_inicio TEXT,
            fecha_fin TEXT,
            peso_decimal TEXT NOT NULL,
            orden INTEGER NOT NULL CHECK(orden>=0),
            UNIQUE(id_simulacion,clave_periodo),
            UNIQUE(id_simulacion,orden),
            UNIQUE(id_comunidad,id_simulacion_periodo),
            FOREIGN KEY(id_comunidad,id_simulacion) REFERENCES erp_simulaciones(id_comunidad,id_simulacion),
            CHECK(fecha_fin IS NULL OR fecha_inicio IS NULL OR fecha_fin>=fecha_inicio)
        )""",
        """CREATE TABLE erp_simulacion_resultados (
            ...
            creado_en TEXT NOT NULL,
            UNIQUE(id_comunidad,id_simulacion),
            UNIQUE(id_comunidad,hash_resultado),
            FOREIGN KEY(id_comunidad,id_simulacion) REFERENCES erp_simulaciones(id_comunidad,id_simulacion)
        )""",
        """CREATE TABLE erp_calculo_componentes (
            id_calculo_componente INTEGER PRIMARY KEY AUTOINCREMENT,
            id_comunidad INTEGER NOT NULL,
            id_simulacion INTEGER NOT NULL,
            id_calculo_linea INTEGER NOT NULL,
            id_propiedad INTEGER NOT NULL,
            id_partida INTEGER,
            id_asignacion INTEGER,
            clave_componente TEXT NOT NULL,
            id_regla_version INTEGER NOT NULL,
            numerador_exacto TEXT NOT NULL,
            denominador_exacto TEXT NOT NULL,
            importe_base_centimos INTEGER NOT NULL,
            ajuste_redondeo_centimos INTEGER NOT NULL,
            importe_final_centimos INTEGER NOT NULL,
            residuo_numerador TEXT NOT NULL,
            residuo_denominador TEXT NOT NULL,
            criterio_redondeo TEXT NOT NULL,
            orden_desempate TEXT NOT NULL,
            UNIQUE(id_simulacion,id_asignacion,clave_componente,id_propiedad),
            UNIQUE(id_comunidad,id_calculo_componente),
            FOREIGN KEY(id_comunidad,id_simulacion) REFERENCES erp_simulaciones(id_comunidad,id_simulacion),
            FOREIGN KEY(id_comunidad,id_calculo_linea) REFERENCES erp_calculo_lineas(id_comunidad,id_calculo_linea),
            FOREIGN KEY(id_comunidad,id_propiedad) REFERENCES cf_propiedades(id_comunidad,id_propiedad),
            FOREIGN KEY(id_comunidad,id_regla_version) REFERENCES erp_regla_versiones(id_comunidad,id_regla_version)
        )""",
        """CREATE TABLE erp_calculo_periodo_resultados (
            id_calculo_periodo_resultado INTEGER PRIMARY KEY AUTOINCREMENT,
            id_comunidad INTEGER NOT NULL,
            id_calculo_linea INTEGER NOT NULL,
            id_simulacion_periodo INTEGER NOT NULL,
            numerador_exacto TEXT NOT NULL,
            denominador_exacto TEXT NOT NULL,
            importe_base_centimos INTEGER NOT NULL,
            ajuste_redondeo_centimos INTEGER NOT NULL,
            ...
            residuo_denominador TEXT NOT NULL,
            criterio_redondeo TEXT NOT NULL,
            UNIQUE(id_calculo_linea,id_simulacion_periodo),
            FOREIGN KEY(id_comunidad,id_calculo_linea) REFERENCES erp_calculo_lineas(id_comunidad,id_calculo_linea),
            FOREIGN KEY(id_comunidad,id_simulacion_periodo) REFERENCES erp_simulacion_periodos(id_comunidad,id_simulacion_periodo)
        )""",
        "CREATE INDEX idx_erp_simulacion_periodo ON erp_simulacion_periodos(id_comunidad,id_simulacion,orden)",
