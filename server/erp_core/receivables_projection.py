...
def validate_timeline(conn, community_id, receipt_ids=(), collection_ids=(), credit_ids=()):
    """A backdated operation must not overdraw any later effective cutoff."""
    dates={date.today().isoformat()}
    for table in ('erp_imputaciones','erp_devoluciones','erp_rectificaciones','erp_credito_aplicaciones','erp_reintegros','erp_reasignaciones_obligacion'):
