...
assert.equal(grounded.payload.estado_nuevo,'Terminada');
...
assert.equal(normalizeFollowup({...raw,fecha_objetivo_proximo_paso:'2026-09-10',evidencias:{fecha:'Hoy'}},{text:'Hoy he hablado con Paquito. Si aceptamos el presupuesto iremos a Valeriano.',item,target,sourceDate:'2026-09-10'}).payload.fecha_objetivo_proximo_paso,'');
