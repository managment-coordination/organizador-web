...
requireIncludes("const reviewed = withAiProposalContract(proposal);", "analyzeWithAi no normaliza propuesta dirigida");
requireIncludes("await analyzeTargetedFollowup(", "falta analisis contextual independiente");
