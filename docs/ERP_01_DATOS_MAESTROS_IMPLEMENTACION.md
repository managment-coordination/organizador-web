...
- Verificacion especifica: creacion desde Excel propio, seleccion automatica de la columna, duplicado bloqueado, archivo y propietarios conservados, importacion de 40 propiedades/coeficientes en 360/390/1440 px y limites geometricos del formulario. Capturas revisadas en escritorio/movil; regresiones ERP 0/1/2, onboarding y recorrido operativo superadas en copia de Ubuntu.
- Publicado `d3ebcca`, checkpoint `onboarding-inline-group-certified-20260911`. HTTP 200 y nueva interfaz comprobados en LAN y Tailscale (8771). Backup `backups/before-operational-publish-20260911-071410`, checksums correctos y restauracion aislada en `backups/restore-inline-group-ia7o1enj/restored.db`, integridad correcta y sin errores FK. No se crearon grupos ni se importaron datos reales para probar, no hubo migracion y ERP 3 no se inicio.
