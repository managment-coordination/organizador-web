...
- Estado de implementacion: **DESARROLLO, 25% certificado**, implementacion completa autorizada. ERP 4A acreditado. Continuacion 14/09: migraciones 17-18 sobre copia, operaciones de corte/sucesion/excepciones, importacion Excel cifrada, catalogo documental protegido y UI bancaria integrada. 82 pruebas de nucleo, regresiones ERP 0-3 y recorridos HTTPS locales de escritorio/movil (exportacion sin cobro, cobro/imputacion/devolucion, importacion y documentos) superados. **No publicado**; siguen pendientes custodia POSIX/Ubuntu, acciones UX restantes, matriz A01-A50 y shell completo. Operativa real deshabilitada. Evidencia y pendientes exactos en [implementacion ERP 4](ERP_04_DOMICILIACIONES_SEPA_REMESAS_IMPLEMENTACION.md#pendientes-exactos-de-continuacion).
