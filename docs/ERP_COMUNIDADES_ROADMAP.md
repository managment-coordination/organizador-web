...
- Estado de implantacion: **COMPLETADO, 100% certificado**, cuatro hitos de 25 puntos acreditados. Diseno CERRADO 100%, D1-D6 intactas. Activacion historica, exportacion exacta auditada, imputacion N:M, consultas contextuales, Excel, emision 40/16 y roles escritorio/movil verificados. Paquete publicado en Ubuntu con 42/42 pruebas, regresiones ERP 0/1/2 y operativas, matriz de 35 casos, backups previo/posterior restaurados con HTTP y 121 tablas ERP/CF identicas. Codigo instalado `aaadb1b`; checkpoint final `erp3-completed-20260911`. Evidencias y limites en [cierre ERP 3](ERP_03_RECIBOS_COBROS_DEUDA_IMPLEMENTACION.md#cierre-certificado). La activacion economica real por comunidad sigue requiriendo permisos y cobertura acreditados; no se han generado recibos reales. ERP 4 no iniciado.
...
- Estado de implementacion: **COMPLETADO, 100% certificado tecnico**. ERP 4A/4B/4C/4D acreditados. Servicios, lote 200, Excel cifrado, catalogo protegido, UI y contextos integrados; 91/91 pruebas mas rollback de cancelacion (92), adaptador 17/17, matriz A01-A50 y regresiones ERP 0-3. Publicado en Ubuntu/GitHub con codigo `5676f61`, checkpoint `erp4-completed-20260914`; backup previo/posterior restaurados y arrancados, 205 tablas, hashes historicos intactos, smoke de codigo instalado y login escritorio/movil correctos. Operativa bancaria sensible/real bloqueada hasta HTTPS, retencion de claves y configuracion acreditados: no se certifica aceptacion comercial del PSP. Evidencia en [cierre ERP 4](ERP_04_DOMICILIACIONES_SEPA_REMESAS_IMPLEMENTACION.md#cierre-certificado).
- Hitos: ERP 4A contrato/migracion validada **25/25**; 4B servicios deterministas **25/25**; 4C recorrido integrado **25/25**; 4D aceptacion/regresion/restauracion/publicacion **25/25**. [Matriz y evidencias exigidas](ERP_04_DOMICILIACIONES_SEPA_REMESAS.md#15-casos-de-aceptacion-obligatorios).
...
- Contrato: [ERP 5 - Banco y conciliacion](ERP_05_BANCO_CONCILIACION.md), v1.0, 14/09/2026. **Diseno 100%, COMPLETADO y cerrado**. Implementacion **COMPLETADO, 100% certificado**: 5A migracion/adaptadores 25/25, 5B servicios/integracion 25/25, 5C recorrido web/contextos 25/25 y 5D aceptacion/regresion/publicacion/restauracion 25/25. [Matriz A01-A64, pruebas y recuperacion](ERP_05_BANCO_CONCILIACION_IMPLEMENTACION.md). Codigo publicado `2a97015`, cierre `erp5-completed-20260914`. Cierre tecnico; operativa bancaria real deshabilitada hasta acreditar HTTPS, custodia y configuracion por comunidad.
...
- Aceptacion: matriz A01-A64 completada con escenarios sinteticos/copias. 58 pruebas de dominio, 22 de adaptadores, 15 de integracion; regresion completa previa ERP 0-4/planes y gate final con los cambios nuevos; web real HTTPS en 1440/1920/390 y contextos de fichas. Publicacion conserva 206 tablas de negocio existentes; backups previos/posteriores restaurados con arranque y SQLite/FK correctas. Smoke localhost/Tailscale y cinco casos economicos/permisos sobre copia de la version publicada correctos. Eventos ERP 6 distinguen evidencia de hecho monetario; no se generan asientos.
...
ERP 0/1/2/3/4/5 y ampliacion de planes completados tecnicamente. ERP 5: **diseno cerrado 100%, implementacion 100% certificado**, publicado, restaurable y aceptado conforme a su matriz. HTTPS, custodia organizativa/retencion, permisos y configuracion bancaria/fuente/corte por comunidad siguen siendo puertas de activacion real. ERP 6 puede comenzar por cerrar su contrato con autorizacion del usuario; no avanzar automaticamente ni generar contabilidad definitiva.
