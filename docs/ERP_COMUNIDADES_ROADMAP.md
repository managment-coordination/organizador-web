...
- Estado de implantacion: PRUEBAS. Diseno CERRADO 100%, D1-D6 intactas. Implantacion certificada: **75%**, hitos 1-3 acreditados: contrato/migraciones, servicios deterministas y recorrido funcional integrado. Activacion historica, exportacion exacta auditada, imputacion N:M, consultas contextuales, Excel, emision 40/16 y roles escritorio/movil verificados. Falta certificar el paquete final en Ubuntu, backup/restauracion productivos HTTP y publicacion con smoke para conceder el cuarto hito. Matriz de los 35 casos, checkpoints y pendientes en [implementacion ERP 3](ERP_03_RECIBOS_COBROS_DEUDA_IMPLEMENTACION.md#candidato-de-cierre). No se ha publicado todavia; no avanzar ERP 4.
...
ERP 2 completado con 100% certificado. ERP 3: **75%**, contrato cerrado y recorrido integrado verificado. Completar la puerta final Ubuntu/restauracion/publicacion documentada en [implementacion](ERP_03_RECIBOS_COBROS_DEUDA_IMPLEMENTACION.md#candidato-de-cierre), sin repetir servicios ya aceptados. No requiere autorizacion entre subfases. Mantener planes/cuotas ERP 2 inmutables; no avanzar ERP 4/5/6.
