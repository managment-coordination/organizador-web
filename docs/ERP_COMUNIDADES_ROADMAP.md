...
- Estado de implantacion: DESARROLLO, autorizado por el usuario. Diseno funcional/tecnico/UX: CERRADO, 100%; D1-D6 ratificadas expresamente el 11/09/2026 e incorporadas al [contrato ERP 3](ERP_03_RECIBOS_COBROS_DEUDA.md). Implantacion certificada: 0%; ningun hito completo concedido todavia, aceptacion funcional completa no ejecutada. Migracion aditiva y primeros servicios probados sobre copias, sin API/UI ni activacion productiva. Evidencia y pendientes en [implementacion ERP 3](ERP_03_RECIBOS_COBROS_DEUDA_IMPLEMENTACION.md). ERP 2 tiene contratos suficientes como origen. La secuencia 3A-3D conserva los cuatro hitos de 25 puntos, sin conceder avance por codigo parcial.
...
ERP 2 completado con 100% certificado y revision UX/onboarding previa superada. ERP 3 ya tiene implementacion autorizada y en curso, con [D1-D6 incorporadas](ERP_03_RECIBOS_COBROS_DEUDA.md#12-decisiones-materiales-ratificadas). Continuar desde [los pendientes de implementacion](ERP_03_RECIBOS_COBROS_DEUDA_IMPLEMENTACION.md), cerrar compatibilidad/servicios, integrar UX y completar aceptacion antes de publicar. Implantacion certificada ERP 3 continua al 0% hasta cerrar hitos completos. Mantener planes/cuotas ERP 2 como origen inmutable; no avanzar ERP 4/5/6.
