...
- Estado de implementacion: **DESARROLLO, 25% certificado**, implementacion completa autorizada por el usuario. ERP 4A acreditado mediante migraciones 13-15 en copia, integridad/FK, regresiones ERP 0-3 y recuperacion del checkpoint con datos cifrados y clave separada. Continuacion: migracion 16, perfiles versionados, exportacion cifrada, descarga de dominio, resultados/rechazos/devoluciones atomicos con ERP 3, reenvios controlados, domiciliacion historica, consultas enmascaradas y transporte bancario dedicado cerrado por defecto. **No publicado**, sin interfaz ERP 4 ni custodia productiva validada; quedan servicios de contrato y aceptacion integral. Evidencia y pendientes exactos en [implementacion ERP 4](ERP_04_DOMICILIACIONES_SEPA_REMESAS_IMPLEMENTACION.md).
- Hitos: ERP 4A contrato/migracion validada **25/25**; 4B servicios deterministas **0/25** (parcial, sin acreditar); 4C recorrido integrado **0/25**; 4D aceptacion/regresion/restauracion/publicacion **0/25**. Las pruebas ampliadas del nucleo y las 17 del adaptador no equivalen a los 50 casos integrales. [Matriz y evidencias exigidas](ERP_04_DOMICILIACIONES_SEPA_REMESAS.md#15-casos-de-aceptacion-obligatorios).
...
ERP 0/1/2/3 completados. ERP 3: **100% certificado y publicado**, con [cierre y restauracion documentados](ERP_03_RECIBOS_COBROS_DEUDA_IMPLEMENTACION.md#cierre-certificado). ERP 4 tiene [diseno cerrado al 100%](ERP_04_DOMICILIACIONES_SEPA_REMESAS.md), implementacion **25% certificada**, no publicada y ninguna decision funcional material pendiente. Continuar autonomamente desde `erp4-progress-results-access-20260911` (codigo `df7469f`, 64 pruebas de nucleo, restauracion 201 tablas/secretos/adaptador/transporte verificada) con los [pendientes exactos de ERP 4B-4D](ERP_04_DOMICILIACIONES_SEPA_REMESAS_IMPLEMENTACION.md#pendientes-exactos-de-continuacion), sin reiniciar los fundamentos ni solicitar autorizacion entre subfases. La configuracion bancaria y custodia real se acreditan antes del uso productivo. No iniciar ERP 5/6.
