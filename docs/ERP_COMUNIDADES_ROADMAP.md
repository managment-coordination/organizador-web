...
- Estado de implementacion: **PRUEBAS, 75% certificado**, implementacion completa autorizada. ERP 4A/4B/4C acreditados. Servicios, lote 200, importacion Excel cifrada, catalogo protegido y UI/contexto integrados. 91/91 pruebas de nucleo mas rollback de cancelacion (92); navegador masivo 200 y app completa HTTPS/POSIX en Ubuntu aislado. Matriz A01-A50 trazada; custodia externa y copia DPAPI recuperada. **No publicado**; quedan gate de regresion/restauracion del candidato y publicacion/smoke final. Operativa bancaria sensible/real bloqueada hasta HTTPS y configuracion acreditados; no es una decision funcional pendiente. Evidencia en [implementacion ERP 4](ERP_04_DOMICILIACIONES_SEPA_REMESAS_IMPLEMENTACION.md#pendientes-exactos-de-continuacion).
- Hitos: ERP 4A contrato/migracion validada **25/25**; 4B servicios deterministas **25/25**; 4C recorrido integrado **25/25**; 4D aceptacion/regresion/restauracion/publicacion **0/25**, a certificar tras su cierre. [Matriz y evidencias exigidas](ERP_04_DOMICILIACIONES_SEPA_REMESAS.md#15-casos-de-aceptacion-obligatorios).
...
ERP 0/1/2/3 completados. ERP 4: diseno cerrado, **75% certificado**, servicios/UI/recorridos terminados y ninguna decision funcional material pendiente. Cerrar los [pendientes de publicacion](ERP_04_DOMICILIACIONES_SEPA_REMESAS_IMPLEMENTACION.md#pendientes-exactos-de-continuacion) desde el candidato de aceptacion actual. No reiniciar los servicios ni repetir el diseno. HTTPS y configuracion bancaria real siguen siendo puertas de activacion, no autorizacion implicita. No iniciar ERP 5/6.
